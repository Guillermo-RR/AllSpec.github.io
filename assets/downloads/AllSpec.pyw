...
class AppPrincipal:
    def __init__(self, master):
        ...
        self.mensajes_dia = {
            0: "🔍 Lunes: Nueva semana,nuevos proyectos.",
            1: "💡 Martes: Recuerda siempre respaldar tus archivos.",
            2: "🧪 Miércoles: No olvides calibrar tus equipos.",
            3: "📊 Jueves: Utiliza siempre el equipo de seguridad.",
            4: "🧼 Viernes: Limpia bien tus celdas.",
            5: "📁 Sábado: Revisa bien tus notas.",
